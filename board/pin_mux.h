...
/*! @name PORTE6 (number 7), J15[G1]/SD_CARD_DETECT
  @{ */
#define BOARD_INITPINS_SDHC_CD_GPIO GPIOE /*!<@brief GPIO device name: GPIOE */
#define BOARD_INITPINS_SDHC_CD_PORT PORTE /*!<@brief PORT device name: PORTE */
#define BOARD_INITPINS_SDHC_CD_PIN 6U     /*!<@brief PORTE pin index: 6 */
                                          /* @} */
...
/*! @name PORTC7 (number 79), J1[13]
  @{ */
#define BOARD_INITPINS_CMP0_IN1_GPIO GPIOC /*!<@brief GPIO device name: GPIOC */
#define BOARD_INITPINS_CMP0_IN1_PORT PORTC /*!<@brief PORT device name: PORTC */
